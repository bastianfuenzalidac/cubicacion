...
Public Class crDespachosCreados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cubicacion.crDespachosCreados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDespachosCreados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDespachosCreados = New crDespachosCreados()
        rpt.Site = Me.Site
        Return rpt
    End Function
