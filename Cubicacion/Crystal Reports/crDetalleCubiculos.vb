...
Public Class crDetalleCubiculos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cubicacion.crDetalleCubiculos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDetalleCubiculos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDetalleCubiculos = New crDetalleCubiculos()
        rpt.Site = Me.Site
        Return rpt
    End Function
