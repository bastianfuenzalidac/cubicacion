...
Public Class frmDespachosPendientes
    ...
    Public Sub cargardataCubiculo()
        Try
            ...
            command = New SqlCommand("sp_ResumenDespachosPendientes", cnn)
    ...
    Public Sub cargardataCubiculoTodos()
        Try
            ...
            cnn.Open()
            'Indico el SP que voy a utilizar
            command = New SqlCommand("sp_ResumenDespachosPendientesTodos", cnn)
            command.CommandType = CommandType.StoredProcedure
            command.ExecuteNonQuery()
    ...
    Public Sub cargardataCubiculoNorden()
        Try
            ...
            cnn.Open()
            'Indico el SP que voy a utilizar
            command = New SqlCommand("sp_ResumenDespachosPendientesNorden", cnn)
            command.CommandType = CommandType.StoredProcedure
