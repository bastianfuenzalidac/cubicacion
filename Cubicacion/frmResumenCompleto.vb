...
Public Class frmResumenCompleto
    ...
    Public Sub cargardataCubiculo()
        Try
            ...
            command = New SqlCommand("sp_ResumenCompleto", cnn)
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Catch ex As Exception
            ...
            cmd4.Parameters.AddWithValue("@fecha_Ingreso", Date.Now)
            cmd4.Parameters.AddWithValue("@id_EmpleadoIngreso", clsLogin.IdUsuario)
            cmd4.Parameters.AddWithValue("@Detalle", "ERROR AL GENERAR REPOTE COMPLETO " & ex.Message)
